-- Deploy SDLC Sequence Fix
-- This script deploys the updated SDLC_CREATE_WORK procedure to use sequence-based numbering
...
-- Drop existing procedure to avoid overload issues
DROP PROCEDURE IF EXISTS SDLC_CREATE_WORK(STRING, STRING, STRING, STRING, STRING, NUMBER, BOOLEAN, STRING);

-- Create updated procedure with sequence-based numbering
